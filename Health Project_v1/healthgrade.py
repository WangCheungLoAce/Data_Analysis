...
def parse_doctor_info(driver):
    ...
    for doctor in doctors:
        try:
            ...
            address = doctor.find_element(By.CSS_SELECTOR, 'span.location-info-address__address').text
            ...
            city_state_zip = doctor.find_element(By.CSS_SELECTOR, 'span.location-info-address__city-state').text
            data.append({
                'Name': name,
                'Specialty': specialty,
                'Rating': rating,
